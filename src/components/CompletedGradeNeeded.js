...
const CompletedGradeNeeded = () => {
    ...
    const {documents, error} = useCollection('projects','grade','==', compare,'completedDate','asc')

    return (
 <>
            <h2 className='completed-header'>Completed Assignments needs graded</h2>
...
export default CompletedGradeNeeded;