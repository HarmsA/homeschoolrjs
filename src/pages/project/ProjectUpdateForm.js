...
const ProjectUpdateForm = ({docTitle, docDueDate, docCompleted, docAssignedCategory, docAssignmentDetails, projectId, docCompletedDate, docGrade}) => {
    ...
    const [assignedCategory, setAssignedCategory] = useState(docAssignedCategory);
                    ...
                    <Stack spacing={4} sx={{width: 'auto'}}>
                       ...
                       />
                        ...
                        <FormControl sx={{ m: 1, minWidth: 120 }}>
                            ...
                            >
                            <MenuItem defaultValue='' disabled>Category</MenuItem>
                                {categories.map((category) => <MenuItem key={category.value}
                                       value={category.label}>{category.label}</MenuItem>)}
                            </Select>
                            {/*{isUpdating &&*/}
                        <FormControlLabel
                            control={
